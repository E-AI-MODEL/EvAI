...
class SeedMemory:
    ...
    def get_active_seeds(self, context=None):
        """Return all currently active seeds.

        The optional ``context`` argument is accepted for future filtering
        logic. It is not used in this simplified implementation but allows
        callers to pass in runtime context without errors.
        """
